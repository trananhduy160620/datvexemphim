...
exports.getPhimDangChieu = async (req, res, next) => {
  ...
  var sql = 'select DISTINCT "SuatChieu"."IDPhim", "ID", "Ten", "NgayCongChieu", "Poster", "ThoiLuong" from "SuatChieu" join "Phim" on "SuatChieu"."IDPhim" = "Phim"."ID" where "SuatChieu"."IDRap" = ' + String(idCinema);
